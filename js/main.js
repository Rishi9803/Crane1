...
const baseUrl = window.location.hostname === 'yourusername.github.io' 
    ? '/your-repo-name' 
    : '';
...
const equipmentData = [
    {
        ...
        image: `${baseUrl}/images/mobile-crane.jpg`,
        specs: {
            capacity: '50 Tons',
            height: '40m',
            reach: '35m'
    ...
    },
    {
        ...
        image: `${baseUrl}/images/tower-crane.jpg`,
        specs: {
            capacity: '100 Tons',
            height: '80m',
            reach: '60m'
    ...
    equipmentData.forEach(crane => {
        ...
        card.innerHTML = `
            <div class="equipment-image-container">
                <img src="${crane.image}" alt="${crane.name}" loading="lazy" onerror="this.src='./images/placeholder-crane.jpg'; this.onerror=null;">
            </div>
...
function preloadImages() {
    const imageUrls = equipmentData.map(crane => crane.image);
...
// Add this to help debug image loading issues
function checkImagePaths() {
    equipmentData.forEach(crane => {
        const img = new Image();
        img.onload = () => {
            console.log(`Successfully loaded: ${crane.image}`);
        };
        img.onerror = () => {
            console.error(`Failed to load: ${crane.image}`);
        };
        img.src = crane.image;
    });
}
